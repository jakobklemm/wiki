...
of repetitions, /breaking the chain/ becomes a reason to keep the habit
going.
...
might be helpful to use [[file:habit_stacking.org][Habit stacking]] to trigger the tracking of a
